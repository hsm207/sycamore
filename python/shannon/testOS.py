...
def test_pdf_to_opensearch():
    ...
    paths = str("/Users/parthparmar/github/shannon/python/shannon/tests/resources")
    context = shannon.context.init()
...
print(ray.get(test_pdf_to_opensearch.remote()))
